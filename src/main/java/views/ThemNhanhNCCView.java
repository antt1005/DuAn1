...
import services.ThemNhanhNCCService;
 ...
 * @author ktkha
 */
public class ThemNhanhNCCView extends javax.swing.JFrame {
    
    private IManageThemNhanhNCCService SV = new ThemNhanhNCCService();

    /**
     * Creates new form ThemNhanhNCCView
     */
    public ThemNhanhNCCView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 0, 0)), "Thêm Nhanh NCC", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
        ...
        txtDiaChi.setBackground(new java.awt.Color(255, 204, 255));
        ...
        txtSDT.setBackground(new java.awt.Color(255, 204, 255));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        boolean b = SV.add(ncc);
        if (b == true) {
            Icon icon = new javax.swing.ImageIcon(getClass().getResource("/img/themmoiicon.png"));
            JOptionPane.showMessageDialog(this, "Thêm nhanh thành công", "Nhà Cung Cấp", JOptionPane.INFORMATION_MESSAGE, icon);
            ChiTietSanPhamView.loadcbc();
        } else {
            Icon icon = new javax.swing.ImageIcon(getClass().getResource("/img/deleteicon.png"));
            JOptionPane.showMessageDialog(this, "Thêm nhanh thất bại!", "Nhà Cung Cấp", JOptionPane.INFORMATION_MESSAGE, icon);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemNhanhNCCView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemNhanhNCCView().setVisible(true);
            }
        });
    }
