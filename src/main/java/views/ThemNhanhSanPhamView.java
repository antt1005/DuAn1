...
import services.ThemNhanhSPService;
 ...
 * @author ktkha
 */
public class ThemNhanhSanPhamView extends javax.swing.JFrame {

    private IManageThemNhanhSPService SV = new ThemNhanhSPService();

    /**
     * Creates new form ThemNhanhSanPhamView
     *
     *
     */
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 0, 0)), "Thêm Nhanh Sản Phẩm", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (b == true) {
            ...
            JOptionPane.showMessageDialog(this, "Thêm nhanh thành công", "Sản Phẩm", JOptionPane.INFORMATION_MESSAGE, icon);
            ChiTietSanPhamView.loadcbc();
        } else {
            Icon icon = new javax.swing.ImageIcon(getClass().getResource("/img/deleteicon.png"));
            JOptionPane.showMessageDialog(this, "Thêm nhanh thất bại!", "Sản Phẩm", JOptionPane.INFORMATION_MESSAGE, icon);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemNhanhSanPhamView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemNhanhSanPhamView().setVisible(true);
            }
        });
    }
