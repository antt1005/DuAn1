 ...
 * @author admin
 */
public class ViewModelQuenMatKhau {
    ...
    public String toString() {
        ...
        return "ViewModelQuenMatKhau{" + "id=" + id + ", ma=" + ma + ", hoTen=" + hoTen + ", sdt=" + sdt + ", diaChi=" + diaChi + ", ngaySinh=" + ngaySinh + ", idCH=" + idCH + ", idCV=" + idCV + ", matKhau=" + matKhau + ", email=" + email + '}';
